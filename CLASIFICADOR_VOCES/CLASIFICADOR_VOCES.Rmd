...
df_analisis_mel <- df_caract %>%
  ...
  dplyr::filter(pista %in% paste0("0", c(1:3)))
...
Si analizamos los valores de los formantes obtenemos paradójicamente la inversa de lo esperado.
