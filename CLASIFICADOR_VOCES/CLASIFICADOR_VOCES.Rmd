...
ggarrange(p_hnr1, p_hnr2, ncol=2)
```
...
X_train <- train %>% select(-genero, -id_audio, -locutor) # Variables predictoras
y_train <- train$genero                                   # Etiqueta
...
rf_model <- randomForest(x = X_train, y = as.factor(y_train), ntree = 20)

# Evaluar el modelo en el conjunto de test
rf_predictions <- predict(rf_model, X_test)
confusionMatrix(as.factor(rf_predictions), as.factor(y_test))
...
confusionMatrix(as.factor(svm_predictions), as.factor(y_test))
