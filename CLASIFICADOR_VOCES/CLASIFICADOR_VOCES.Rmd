...
df_analisis_mel <- df_caract %>%
  ...
  dplyr::filter(pista %in% paste0("0", c(1:4)))
...
knitr::kable(df_e, format = "latex", 
             booktabs = TRUE, 
             caption = "Media de los formantes en vocal E", 
             align = 'lll', centering = TRUE,
             table.envir = "table", position = "H")
```


```{r extraccion_caract_for_A}
# Vocal A
...
knitr::kable(df_a, format = "latex", 
             booktabs = TRUE, 
             caption = "Media de los formantes en vocal A", 
             align = 'lll', centering = TRUE,
             table.envir = "table", position = "H")
```
